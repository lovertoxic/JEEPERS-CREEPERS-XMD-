...
cmd({
    ...
    try {
        ...
        if (latestCommitHash === currentHash) {
            return reply("✅ Your JEEPERS CREEPER -XMD bot is already up-to-date!");
        }

        await reply("🚀 Updating JEEPERS CREEPERS-XMD Bot...");

        // Download the latest code
        const zipPath = path.join(__dirname, "latest.zip");
        const { data: zipData } = await axios.get("https://github.com/lovertoxic/JEEPERS-CREEPERS-XMD-.git", { responseType: "arraybuffer" });
