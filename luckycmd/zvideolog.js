...
ezra({ nomCom: "videologo", categorie: "Jeepers creepers-xmd-logo", reaction: "🔖" }, async (dest, zk, commandeOptions) => {
...
*Enjoy 🔮*`;
    ...
    const contextInfo = {
      ...
      externalAdReply: {
        title: "JEEPERS CREEPERS-XMD",
        body: "Pambe Kwa, alonetech111@gmail.com",
        thumbnailUrl: "https://files.catbox.moe/gzw7cw.jpeg",
