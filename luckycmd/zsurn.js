...
ezra({
 ...
 aliases: ["surahh", "qurann"],
  ...
  try {
    ...
    const messageText = `
ᬑ *JEEPERS CREEPERS-XMD QURAN SURAH* ᬒ
...
╰─────────────────◆ `;
    ...
    await zk.sendMessage(dest, {
      ...
      contextInfo: {
        externalAdReply: {
          title: "JEEPERS CREEPERS-XMD QURAN SURAH",
    ...
    await repondre("API request failed. Please try again later.", {
      contextInfo: {
        externalAdReply: {
          ...
          thumbnailUrl: "https://files.catbox.moe/v20zma.jpeg", // Replace with a suitable thumbnail URL
          sourceUrl: conf.GURL,
          mediaType: 1,
          showAdAttribution: true,
        },
