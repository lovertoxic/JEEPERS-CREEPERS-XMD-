...
> ©Davincs#tech projects
 ...
 `;
   ...
   if (lien.match(/\.(mp4|gif)$/i)) {
    try {
        zk.sendMessage(dest, { video: { url: lien }, caption:infoMsg + menuMsg, footer: "Je suis *Luckymd*, déveloper jeepers-creepers-xmd Tech" , gifPlayback : true }, { quoted: ms });
    }
    catch (e) {
