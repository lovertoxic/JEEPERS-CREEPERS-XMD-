...
ezra({
  ...
  try {
    // Caption for the screenshot
    const cap = `*Screenshot take by JEEPERS CREEPERS-XMD*`;
...
ezra({
  ...
  try {
    ...
    message.sendMessage(user, {
      'image': { 'url': imageUrl },
      'caption': "*powered by JEEPERS CREEPERS-XMD*"
    }, { 'quoted': ms });
  } catch (error) {
    console.error("Error:", error.message || "An error occurred");
    sendMessage("Oops, an error occurred while processing your request");
...
ezra({
  ...
  try {
    ...
    message.sendMessage(user, {
      ...
      'caption': "*powered by JEEPERS CREEPERA-XMD*"
    }, {
...
ezra({
  ...
  try {
    ...
    message.sendMessage(user, {
      ...
      'caption': "*powered by jeepers-creepers*"
    }, {
      'quoted': messageInstance
    });
  } catch (error) {
