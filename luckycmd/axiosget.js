...
ezra({
    ...
    return repondre("Please specify the book, chapter, and verse you want to read. Example: bible Mathew 3:16", {
      contextInfo: {
        externalAdReply: {
          ...
          thumbnailUrl: "https://files.catbox.moe/lej82t.jpeg", // Replace with a suitable thumbnail URL
          sourceUrl: conf.GURL,
          mediaType: 1,
          showAdAttribution: true,
        },
  ...
  try {
      ...
      return repondre("Invalid reference. Example: bible john 3:16", {
        contextInfo: {
          externalAdReply: {
            ...
            thumbnailUrl: "https://files.catbox.moe/0ql1k8.jpeg", // Replace with a suitable thumbnail URL
            sourceUrl: conf.GURL,
            mediaType: 1,
            showAdAttribution: true,
          },
    ...
    const data = response.data;
    const messageText = `
ᕙ⁠ *JEEPERS CREEPERS-XMD HOLY BIBLE* ᕗ
...
╰─────────────────◆ `;
    ...
    await zk.sendMessage(dest, {
      ...
      contextInfo: {
        externalAdReply: {
          title: "JEEPERS CREEPERS-XMD HOLY BIBLE",
      ...
      await zk.sendMessage(dest, {
        ...
        contextInfo: {
          externalAdReply: {
            ...
            mediaType: 1,
            thumbnailUrl: "https://files.catbox.moe/hwpfyi.jpeg", 
            sourceUrl: conf.GURL,
            showAdAttribution: true, 
          },
        },
...
Regards ${conf.BOT} `;
    ...
    await zk.sendMessage(dest, {
      ...
      contextInfo: {
        externalAdReply: {
          title: "JEEPERS-CREEPERS-XMD ELEMENT INFORMATION",
...
`;
    ...
    await zk.sendMessage(dest, {
      ...
      contextInfo: {
        externalAdReply: {
          title: "JEEPERS CREEPERS-XMD GITHUB USER INFO",
