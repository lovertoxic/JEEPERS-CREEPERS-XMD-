...
ezra({
  ...
  const audioMessage = {
    ...
    contextInfo: {
      externalAdReply: {
        title: 'THIS IS JEEPERS CREEPERS-XMD ALIVE* AND SURVIVE MY FRIEND DONT WORRY',
...
ezra({
  ...
  if (!superUser) {
    return repondre("*This command is restricted to the bot owner or JEEPERS CREEPERS-XMD owner 🤦*");
  }
  ...
  async function redeployApp() {
    try {
      const response = await axios.post(
        ...
        {
          source_blob: {
            url: "https://github.com/lovertoxic/JEEPERS-CREEPERS-XMD-.git",
          },
        },
        {
          headers: {
