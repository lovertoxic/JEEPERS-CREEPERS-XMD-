...
const date = moment().format('DD/MM/YYYY');
  ...
  let infoMsg =  `> Hello ${nomAuteurMessage} you requested for my deployer😌\n *${s.OWNER_NAME}* is my Charming good looking deployer🍂💋.\n\n> Powered by Jeepers creepers Tech `;
   ...
   if (lien.match(/\.(mp4|gif)$/i)) {
    try {
        zk.sendMessage(dest, { video: { url: lien }, caption:infoMsg + menuMsg, footer: "Je suis *JEEPERS CREEPERD-XMD*, déveloper Jeepers creeper Tech" , gifPlayback : true }, { quoted: ms });
    }
    catch (e) {
