...
ezra(
    ...
    async (dest, zk, commandeOptions) => {
        ...
        let z =
            "Hello I'm *✧JEEPERS CREEPERS-XMD✧* \n\n " +
            "I'm a powerful Whatsapp Bot supporting you";
        let d = " Made By *sir jeepers-creepers *";
        let varmess = z + d;
        var img = "https://files.catbox.moe/hwpfyi.jpeg";
...
const vcard = 'BEGIN:VCARD\n' // metadata of the contact card
            + 'VERSION:3.0\n' 
            + 'FN:F Sir @jeepers creeper\n' // full name
            + 'ORG:Ashoka Uni;\n' // the organization of the contact
            + 'TEL;type=CELL;type=VOICE;waid=254717263689:+254724908267\n' // WhatsApp ID + phone number
            + 'END:VCARD'
